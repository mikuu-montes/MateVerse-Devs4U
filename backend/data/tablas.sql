...
('Este es tu idolo??, un maleducado, los argentinos todos agrandados', 'Inaceptable', '😡', true, 1, 6),
('Idola moriaa, poniendo los puntos como corresponde!!', 'IDOLA', '😜', false, 2, 1),
('No soy muy amante de moria, pero banco lo que dijoo', 'necesario', NULL, false, 2, 2),
('Siempre es un placer escuchar a Moria', 'Gustoso', NULL, false, 2, 3),
('Frase clásica argentina', 'Clásico', '😎', true, 3, 1),
('Aguante Francella!!', 'buenisimo', NULL, false, 3, 2),
('Aguante rancing y aguante francella', 'RACING!!', NULL, false, 3, 4),
('Me gusta más la versión del hombre', 'adaptable', NULL, false, 4, 1),
('No lo uso mucho pero banco', 'aceptable', NULL, false, 4, 2),
('Lo re usoo, bancamos a lilita', 'usadoo', NULL, true, 4, 3),
('Entiendo que es en un tono humoristico, pero es muy triste si lo pensamos bien', 'Insensible', '😶', false, 5, 3),
('Nada mejor que ver esperando la carroza un finde en familia', 'Memorativo', '❤️', false, 5, 1),
('Coki y Paola siempre haciendo de las suyas', 'Tipico', '😂', false, 6, 1),
('me encanta usar este meme, Fort siempre va a ser un clasico', 'Intocable', '❤️', false, 7, 1),
('Fort siempre en nuestros dos corazones', 'Respeto', '🙏', false, 7, 3),
('Ojala tener la tranquilidad economica de Fort', 'Idolo', NULL, false, 7, 6),
('No lo uso como meme, pero me encanta', 'graciosoo', NULL, false, 9, 1),
('Amo casados con hijos, adoro a pepe', 'encantado', '❤️', false, 9, 4),
('Amo a Limonnn', 'divino', '😍', false, 10, 3),
('Aguante Limonnn', 'idolo', '😜', false, 10, 4),
('Yo antes de rendir los finales de febrero:', 'POV', NULL, false, 12, 1),
('Yo manifestando aprobar IDS', 'sueño', '🙏', false, 12, 3),
('El comandante todo que verr', 'theking', '🤭', false, 12, 3),
('Marley no nos desconozcamoss', 'desconocimiento', NULL, false, 14, 4);
